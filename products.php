...
?>
            ...
            <div class="container" style="margin-top:20px;">
                <div class="row">
                    ...
                    <!-- !BANNER 2-1 SLIDE END -->
                    
                    <!-- !BANNER 2-2 START --> 
                    
                    
                    <div class="col-xs-12 col-sm-8 col-md-8" style="min-height:50px;">
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                ...
                                <div class="thumbnail">
                                    <div style="border-bottom:1px solid #ebebeb;">
                                        <img src="image/products/accessories/p2.jpg" alt="" class="prod_img">
                                    </div>
                                    <div class="caption" style="background-color:#f9f9f9; border-bottom:1px solid #ebebeb;">
                                        <h4 class="pull-right ">$64.99</h4>
                                        <h4><a href="#">Second Product</a>
                                        </h4>
                                        <p>This is a short description. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                    </div>
                                    <div class="ratings" style="height:59px;">
                                        <button type="button" class="pull-left btn btn-default btn-cons" style="margin-top:12px">
                                            <span style="font-size:16px;padding-right:5px" class="pull-left hidden-xs showopacity glyphicon glyphicon-info-sign"></span>
                                            Details</button> 
                                        <button type="button" class="pull-right btn btn-info " style="margin-top:12px">
                                             <span style="font-size:16px;padding-right:5px" class="pull-left hidden-xs showopacity glyphicon glyphicon-shopping-cart"></span>
                                              Add to Cart
                                         </button>
                                    </div>
                                </div>
